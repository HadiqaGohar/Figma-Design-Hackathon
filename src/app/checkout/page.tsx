...
import { client, urlFor } from "@/sanity/lib/client"; // Assuming this is a custom function to get image URL from Sanity
...
const shippingPrice = 100; // Adjust as needed
const totalPrice = (cartTotal + shippingPrice) * 100; // Convert to cents
    ...
    <div className=" w-full mx-auto">
      ...
      {stripePromise && clientSecret && (
        <Elements stripe={stripePromise} options={{ clientSecret }}>
         <div className="max-w-screen-xl mx-auto flex flex-col lg:flex-row justify-between items-center w-full  my-10">
  <div className="flex-1 flex justify-center items-center">
    <ShippingRatesPage cartItems={cartItems} />
  </div>
  <div className="flex-1 flex justify-center items-center">
    <PaymentForm />
  </div>
...
function ShippingRatesPage({ cartItems }: { cartItems: any[] }) {
    ...
    <div className="mx-auto p-6">
      ...
      <div className="flex flex-col lg:flex-row mx-10 gap-6 mt-8">
        ...
        <div className="w-full  px-4 lg:px-6">
          <h3 className="font-semibold text-2xl mt-6 mb-8">Order Summary</h3>
          <table className="w-full table-auto  border-gray-200 rounded-lg">
            <thead>
            ...
            <tbody>
              ...
              <tr className="border-t font-semibold">
                <td className="py-2 text-sm sm:text-base">Subtotal</td>
                <td className="py-2 text-right text-sm sm:text-base">${subtotal.toFixed(2)}</td>
              </tr>
              <tr>
                <td className="py-2 text-sm sm:text-base">Shipping</td>
                <td className="py-2 text-right text-sm sm:text-base">${order.shippingPrice.toFixed(2)}</td>
              </tr>
              <tr className="border-b font-semibold">
                <td className="py-2 text-sm sm:text-base">Total</td>
                <td className="py-2 text-yellow-700 text-right text-sm sm:text-xl">${total.toFixed(2)}</td>
              </tr>
            </tbody>
          </table>
        </div>
...
//   const [naddressResidentialIndicatorame, setAddressResidentialIndicator] = useState('');
...
//   const handleShippingSubmit = async (e : any) => {
//     e.preventDefault();
...
//     setError('');
//     try {
//       // Create a new contact document in Sanity
//       await client.create({
//         _type: 'order', // Document type from the schema
//         firstName: firstname,
//         lastName: lastName,
//         phone: phone,
//         email: email,
...
//         // addressResidentialIndicator: setAddressResidentialIndicator,
//       });
...
//         setError('Error submitting contact: ' + err.message);
//       } else {
//         setError('Error submitting contact: An unknown error occurred.');
//       }
//     } finally {
//       setLoading(false);
//     }
...
//           handleSubmit(e); // Call the first submit handler
//           handleShippingSubmit(e); // Call the second submit handler
//         }}
//         className="space-y-6 ">
...
//                     type="text"
//                     id="firstName"
//                     value={shipeToAddress.firstname}
//                     onChange={(e) => {
//                       setfirstName(e.target.value);  // Update firstName state
//                       setshipeToAddress({ ...shipeToAddress, firstname: e.target.value });  // Update the shipeToAddress state
//                     }} 
...
//                     type="text"
//                     id="lastName"
//                     value={shipeToAddress.lastName}
//                     onChange={(e) => {
//                       setlastName(e.target.value);  // Update firstName state
//                       setshipeToAddress({ ...shipeToAddress, lastName: e.target.value });  // Update the shipeToAddress state
//                     }}  className="w-full border border-gray-500 rounded p-3"
//                     required
//                   />
//                 </div>
...
//                   onChange={(e) => {
//                     setCountryCode(e.target.value);  // Update firstName state
//                     setshipeToAddress({ ...shipeToAddress, countryCode: e.target.value });  // Update the shipeToAddress state
//                   }} 
...
//                   onChange={(e) => {
//                     setAddressLine1(e.target.value);  // Update firstName state
//                     setshipeToAddress({ ...shipeToAddress, addressLine1: e.target.value });  // Update the shipeToAddress state
//                   }}
//                   className="w-full border-gray-500 rounded border p-3"
//                   required
//                 />
...
//                     onChange={(e) => {
//                       setCityLocality(e.target.value);  // Update firstName state
//                       setshipeToAddress({ ...shipeToAddress, cityLocality: e.target.value });  // Update the shipeToAddress state
//                     }}
//                     className="w-full border-gray-500 rounded border p-3"
//                     required
//                   />
...
//                   onChange={(e) => {
//                     setPostalCode(e.target.value);  // Update firstName state
//                     setshipeToAddress({ ...shipeToAddress, postalCode: e.target.value });  // Update the shipeToAddress state
//                   }}
//                  className="w-full border-gray-500 rounded border p-3"
//                   required
//                 />
...
//                   onChange={(e) => {
//                     setPhone(e.target.value);  // Update firstName state
//                     setshipeToAddress({ ...shipeToAddress, phone: e.target.value });  // Update the shipeToAddress state
//                   }}
//                   className="w-full border-gray-500 rounded border p-3"
//                   required
//                 />
...
//                   onChange={(e) => {
//                     setEmail(e.target.value);  // Update firstName state
//                     setshipeToAddress({ ...shipeToAddress, email: e.target.value });  // Update the shipeToAddress state
//                   }}
//                  className="w-full border-gray-500 rounded border p-3"
//                   required
//                 />
