  ...
  return (
    <div className="max-w-screen-2xl container mx-auto pb-8 px-4">
      ...
      <div className="mt-8 text-center">
        ...
        <p className="text-sm md:mx-20">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore, mollitia explicabo!
          Consectetur, iste necessitatibus? Harum non qui minus porro, laudantium reprehenderit,
          earum quas, fugiat repellendus facere consectetur. Sint, aliquid! Laboriosam voluptatibus
          tenetur, dolorum quaerat dolorem repellendus quibusdam blanditiis aspernatur laudantium
          iure iste quod consequatur aliquid dolor corrupti vel dolores minima minus, enim provident
          rem officiis! Soluta eius amet quidem ea. Dicta totam nisi magni quod, quas dolores iusto
          dolorum magnam molestiae, incidunt consequuntur perspiciatis deserunt alias est rem omnis
          reiciendis laboriosam exercitationem.
        </p>
      </div>
